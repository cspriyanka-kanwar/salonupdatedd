  ...
  const menuItems = [
    ...
    },
    {
      name: 'Product', icon: <FaShoppingCart />, subMenu: [
        { name: 'Create Category', link: selectedBranch ? `/sadmin/create-category?branchId=${selectedBranch}` : '/sadmin/create-category' },
    ...
    {
      name: 'Client', icon: <FaUsers />, subMenu: [
    ...
    {
      name: 'Payment', icon: <FaCog />, subMenu: [
        { name: 'Assign Branch', link: '/sadmin/assign-branch' }
      ]
    },
